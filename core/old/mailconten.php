						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#a03e49">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
															...
															<table border="0" cellpadding="10" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h2 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:18px;font-weight:normal;margin-bottom:5px;text-align:center;">'.$titulo.'</h2>
														...
														<td valign="top" width="500" class="flexibleContainerCell">
															...
															<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	...
																	<td align="left" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:17px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">'.$mensajeCuerpo.'</h3>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                                                                                    <div>Mensaje generado autom&aacute;ticamente, favor no responder este correo.</div><br>
																			<div>Copyright &#169; '.date('Y').' <a style="text-decoration:none;color:#828282;"><span style="color:#828282;"><a href="www.lahipotecaria.com">www.lahipotecaria.com</a></span></a>. Derechos reservado.</div>
